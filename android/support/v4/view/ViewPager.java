...
public class ViewPager extends ViewGroup
{
  ...
  void populate(int paramInt)
  {
    ...
    while (true)
    {
      ...
      label794: label925: for (Object localObject2 = ((ItemInfo)localObject1).object; ; localObject2 = null)
      {
        ...
        localItemInfo5 = null;
        break label230;
        label496: int i15 = localItemInfo5.position;
        ...
        label582: for (localItemInfo5 = (ItemInfo)this.mItems.get(i7); ; localItemInfo5 = null)
        {
          i8--;
          break;
        }
        label588: if (localItemInfo5 != null)
        {
        ...
        for (localItemInfo5 = (ItemInfo)this.mItems.get(i7); ; localItemInfo5 = null)
          break;
        label701: localItemInfo6 = null;
        break label318;
        label707: int i12 = localItemInfo6.position;
        ...
        label800: if (localItemInfo6 != null)
        {
  ...
  void setCurrentItemInternal(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    label270: if ((bool) && (this.mOnPageChangeListener != null))
      this.mOnPageChangeListener.onPageSelected(paramInt1);
    if ((bool) && (this.mInternalPageChangeListener != null))
      this.mInternalPageChangeListener.onPageSelected(paramInt1);
    completeScroll();

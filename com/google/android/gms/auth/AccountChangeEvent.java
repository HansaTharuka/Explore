  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    while (true)
    {
      ...
      if ((this.Ef != localAccountChangeEvent.Ef) || (this.Eg != localAccountChangeEvent.Eg) || (!jv.equal(this.DZ, localAccountChangeEvent.DZ)) || (this.Eh != localAccountChangeEvent.Eh) || (this.Ei != localAccountChangeEvent.Ei) || (!jv.equal(this.Ej, localAccountChangeEvent.Ej)))
        return false;
    }
    return false;
  }

    ...
    public Intent getIntent()
    {
      ...
      if ((this.anF != null) && (this.anF.size() > i))
      {
        ...
        if ((k != 0) && (bool2))
          break label302;
        int n = i;
        label59: jx.a(n, "Call-to-action buttons are only available for URLs.");
        if ((bool2) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL")))
          break label308;
        int i2 = i;
        label86: jx.a(i2, "The content URL is required for interactive posts.");
        if ((bool2) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL")) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")))
          break label314;
        label122: jx.a(i, "Must set content URL or content deep-link ID to use a call-to-action button.");

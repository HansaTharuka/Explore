...
public class e extends jl<d>
{
  ...
  final class c extends jl<d>.d<BaseImplementation.b<Moments.LoadMomentsResult>>
    implements Moments.LoadMomentsResult
  {
    ...
    public c(Status paramDataHolder, DataHolder paramString1, String paramString2, String arg5)
    {
      ...
      Object localObject1;
      this.OB = localObject1;
      Object localObject2;
      this.anK = localObject2;
    }
  ...
  final class d extends jl<d>.b<BaseImplementation.b<Status>>
  {
    private final Status Eb;
  ...
  final class f extends jl<d>.d<BaseImplementation.b<People.LoadPeopleResult>>
  ...
  final class h extends jl<d>.b<BaseImplementation.b<Status>>
  {
    private final Status Eb;

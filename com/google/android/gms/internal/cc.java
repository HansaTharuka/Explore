...
public final class cc
{
  ...
  public static final cd pT = new cd()
  {
    public void a(gu paramgu, Map<String, String> paramMap)
    {
      ...
      try
      {
        ...
        {
          Uri localUri3 = localk.a(localUri1, paramgu.getContext());
          localUri2 = localUri3;
          String str2 = localUri2.toString();
          new gp(paramgu.getContext(), paramgu.dG().wS, str2).start();
          return;
        }
      }
      catch (l locall)
  ...
  public static final cd pV = new cd()
  {
    public void a(gu paramgu, Map<String, String> paramMap)
    {
      paramgu.q("1".equals(paramMap.get("custom_close")));
    }
  };
  public static final cd pW = new cd()
  {
    public void a(gu paramgu, Map<String, String> paramMap)
    {
      ...
      new gp(paramgu.getContext(), paramgu.dG().wS, str).start();
    }
  };
  public static final cd pX = new cd()
  {
    public void a(gu paramgu, Map<String, String> paramMap)
    {
      gr.U("Received log message: " + (String)paramMap.get("string"));
    }
  };

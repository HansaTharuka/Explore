  ...
  implements cb, ce, cg, cs, ds, dv, ej, ez.a, fc.a, gc, t, w
{
    ...
    try
    {
      ...
      if (!bool1)
      {
        ...
        if (localViewParent != null)
        {
          ...
          int i = arrayOfInt[0];
          int j = arrayOfInt[1];
          DisplayMetrics localDisplayMetrics = this.lB.lM.getResources().getDisplayMetrics();
          int k = this.lB.lK.getWidth();
          int m = this.lB.lK.getHeight();
          boolean bool2 = this.lB.lK.isShown();
          int n = 0;
          if (bool2)
          {
            int i1 = i + k;
      ...
      Bundle localBundle2 = ga.a(this.lB.lM, this, str);
  ...
  public void a(fy.a parama)
  {
    ...
    if (!parama.vK.ug)
    {
      ...
      localgu.setOnTouchListener(new View.OnTouchListener(localv)
      {
      ...
      localgu.setOnClickListener(new View.OnClickListener(localv)
      {
    ...
    while (true)
    {
      ...
      if (this.lB.mg == 0)
      {
        ...
        while (true)
        {
          ar();
          return;
          label648: if ((!(locala instanceof bt)) || (this.lB.lZ == null))
            break;
          as();
        }
  ...
  public void a(String paramString, boolean paramBoolean, int paramInt, Intent paramIntent, ef paramef)
  {
    try
    {
      ...
      gq.wR.postDelayed(new Runnable(paramIntent)
      {
        public void run()
        {
          if ((ei.d(this.lI) == 0) && (u.a(u.this).lT != null) && (u.a(u.this).lT.se != null) && (u.a(u.this).lT.se.dC() != null))
  ...
  boolean a(fy paramfy, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      if ((paramfy.vE != null) && (paramfy.vE.qA > 0L))
      {
        this.lC.a(localav, paramfy.vE.qA);
        continue;
      }
      if ((paramfy.tW) || (paramfy.errorCode != 2))
        continue;
      this.lC.c(localav);
    }
  }

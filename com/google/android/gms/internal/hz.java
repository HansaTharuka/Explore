  ...
  implements AppIndexApi, ht
{
  ...
  public PendingResult<Status> a(GoogleApiClient paramGoogleApiClient, hr[] paramArrayOfhr)
  {
    return paramGoogleApiClient.a(new c(paramGoogleApiClient, ((hx)paramGoogleApiClient.a(hc.CG)).getContext().getPackageName(), paramArrayOfhr)
    {
      protected void a(hu paramhu)
        throws RemoteException
      {
        paramhu.a(new hz.d(this), this.DB, this.DC);
      }
    });
  }
  ...
  private static abstract class c<T extends Result> extends hz.b<Status>
  {

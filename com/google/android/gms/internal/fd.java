  ...
  implements gv.a
{
  ...
  public void cx()
  {
    while (true)
    {
      ...
      synchronized (this.mH)
      {
        ...
        try
        {
          ...
          if (this.tE == null)
            break label451;
          localct = this.tE.qS;
          fy localfy = new fy(localav, localgu, localList1, i, localList2, localList3, j, l1, str1, bool, localcq, localcz, (String)localObject3, localcr, localct, this.tn.tX, this.tB.lS, this.tn.tV, this.tB.vG, this.tn.ua, this.tn.ub, this.tB.vD, null);
      ...
      label393: f(l2);
      continue;
      label402: gr.W(locala.getMessage());
      continue;
      label413: this.tn = new fj(i, this.tn.qA);
      continue;
      label436: String str2 = AdMobAdapter.class.getName();
      Object localObject3 = str2;
      continue;
      label451: ct localct = null;
      continue;
      label457: cq localcq = null;
      continue;
      label463: cz localcz = null;
    }
  }
    ...
    throws fd.a
  {
    ...
    for (int j = this.mContext.getResources().getDisplayMetrics().heightPixels; ; j = localay.heightPixels)
    {
      ...
      gq.wR.post(new Runnable(localfb)
      {
        public void run()
        {
          synchronized (fd.a(fd.this))

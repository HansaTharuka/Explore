  ...
  public boolean equals(Object paramObject)
  {
    ...
    while (true)
    {
      ...
      if (!(paramObject instanceof ov))
        break;
      ov localov = (ov)paramObject;
      if ((!this.packageName.equals(localov.packageName)) || (this.ang != localov.ang) || (this.anh != localov.anh) || (!jv.equal(this.anl, localov.anl)) || (!jv.equal(this.ani, localov.ani)) || (!jv.equal(this.anj, localov.anj)) || (this.ank != localov.ank))
        return false;
    }
    return false;
  }

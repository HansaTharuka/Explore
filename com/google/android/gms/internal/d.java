...
public abstract interface d
{
  public static final class a extends qq<a>
  {
    ...
    public boolean equals(Object paramObject)
    {
          ...
          do
          {
            ...
            do
            {
              ...
              do
              {
                ...
                while (str3 != null);
                bool2 = qu.equals(this.gw, locala.gw);
                i = 0;
              }
              while (!bool2);
              bool3 = qu.equals(this.gx, locala.gx);
              i = 0;
            }
            while (!bool3);
            bool4 = qu.equals(this.gy, locala.gy);
            i = 0;
          }
          while (!bool4);
          if (this.gz != null)
      ...
      do
      {
        boolean bool5 = this.gB < locala.gB;
        i = 0;
        if (bool5)
          break;
        boolean bool6 = this.gC;
        boolean bool7 = locala.gC;
        i = 0;
        if (bool6 != bool7)
          break;
        boolean bool8 = qu.equals(this.gD, locala.gD);
        i = 0;
        if (!bool8)
          break;
        boolean bool9 = qu.equals(this.gE, locala.gE);
        i = 0;
        if (!bool9)
          break;
        boolean bool10 = this.gF;
        boolean bool11 = locala.gF;
        i = 0;
        if (bool10 != bool11)
          break;
        return a(locala);
      ...
      throws IOException
    {
      while (true)
      {
        ...
        case 82:
          ...
          break;
        case 90:
          label849: int j = qz.b(paramqo, 90);
          if (this.gD == null);
          a[] arrayOfa1;

...
public final class fr
{
  ...
  public static fj a(Context paramContext, fh paramfh, String paramString)
  {
    ...
    label340: JSONArray localJSONArray2 = localJSONObject.optJSONArray("impression_urls");
    Object localObject3;
    if (localfj3 == null)
      localObject3 = null;
    label378: int k;
      ...
      if (paramfh.lS.or != null)
      {
        ...
        if (j < i)
        {
          ...
          if (localay.width == -1)
          {
            ...
            label273: localStringBuilder.append(k);
            localStringBuilder.append("x");
            if (localay.height != -2)
              break label338;
          }
          label338: for (int m = (int)(localay.heightPixels / paramfv.vw); ; m = localay.height)
          {

  ...
  implements SafeParcelable
{
  ...
  hd(String paramString, boolean paramBoolean, Account paramAccount, hh[] paramArrayOfhh)
  {
    this(1, paramArrayOfhh, paramString, paramBoolean, paramAccount);
    BitSet localBitSet = new BitSet(ho.fF());
    for (int i = 0; i < paramArrayOfhh.length; i++)
    {
      int j = paramArrayOfhh[i].CZ;
      if (j == -1)
        continue;

...
public abstract interface ra
{
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
            ...
            bool2 = qu.equals(this.azr, locala.azr);
            i = 0;
          }
          while (!bool2);
          bool3 = qu.equals(this.azs, locala.azs);
          i = 0;
        }
        while (!bool3);
        bool4 = qu.equals(this.azt, locala.azt);
        i = 0;
      }
      while (!bool4);
      return a(locala);
  ...
  public static final class c extends qq<c>
  {
    ...
    public boolean equals(Object paramObject)
    {
              ...
              do
              {
                ...
                do
                {
                  ...
                  do
                  {
                    ...
                    while (bool3 != bool4);
                    bool5 = qu.equals(this.azA, localc.azA);
                    i = 0;
                  }
                  while (!bool5);
                  if (this.azB != null)
                ...
                while (localb != null);
                bool6 = Arrays.equals(this.azC, localc.azC);
                i = 0;
              }
              while (!bool6);
              bool7 = Arrays.equals(this.azD, localc.azD);
              i = 0;
            }
            while (!bool7);
            bool8 = Arrays.equals(this.azE, localc.azE);
            i = 0;
          }
          while (!bool8);
          if (this.azF != null)
      ...
      while (str1 != null);
      label258: label322: label339: label356: 
      do
      {
        boolean bool9 = this.azH < localc.azH;
        i = 0;
        if (bool9)
          break;
        return a(localc);
    ...
    public int hashCode()
    {
      ...
      while (true)
      {
        ...
        label214: m = 1237;
        break label65;
        label222: i1 = this.azB.hashCode();
        break label95;
        label234: i3 = this.azF.hashCode();
        break label148;
        label246: i5 = this.azG.hashCode();
      }
    }

...
public final class qm extends qq<qm>
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      bool2 = qu.equals(this.ayq, localqm.ayq);
      i = 0;
    }
    while (!bool2);
    return a(localqm);
        ...
        public boolean equals(Object paramObject)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              while (!bool1);
              locala = (a)paramObject;
              bool2 = Arrays.equals(this.ayv, locala.ayv);
              i = 0;
            }
            while (!bool2);
            if (this.ayw != null)
          ...
          do
          {
            boolean bool3 = Double.doubleToLongBits(this.ayx) < Double.doubleToLongBits(locala.ayx);
            i = 0;
            if (bool3)
              break;
            int j = Float.floatToIntBits(this.ayy);
            int k = Float.floatToIntBits(locala.ayy);
            i = 0;
            if (j != k)
              break;
            boolean bool4 = this.ayz < locala.ayz;
            i = 0;
            if (bool4)
              break;
            int m = this.ayA;
            ...
            if (i1 != i2)
              break;
            boolean bool5 = this.ayC;
            boolean bool6 = locala.ayC;
            i = 0;
            if (bool5 != bool6)
              break;
            boolean bool7 = qu.equals(this.ayD, locala.ayD);
            i = 0;
            if (!bool7)
              break;
            boolean bool8 = qu.equals(this.ayE, locala.ayE);
            i = 0;
            if (!bool8)
              break;
            boolean bool9 = qu.equals(this.ayF, locala.ayF);
            i = 0;
            if (!bool9)
              break;
            boolean bool10 = qu.equals(this.ayG, locala.ayG);
            i = 0;
            if (!bool10)
              break;
            boolean bool11 = qu.equals(this.ayH, locala.ayH);
            i = 0;
            if (!bool11)
              break;
            boolean bool12 = this.ayI < locala.ayI;
            i = 0;
            if (bool12)
              break;
            return a(locala);

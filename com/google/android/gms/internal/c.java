...
public abstract interface c
{
          ...
          do
          {
            ...
            do
            {
              ...
              do
              {
                ...
                bool2 = qu.equals(this.fq, localb.fq);
                i = 0;
              }
              while (!bool2);
              j = this.fr;
  ...
  public static final class c extends qq<c>
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        boolean bool2 = this.fw < localc.fw;
        i = 0;
        if (bool2)
          break;
        boolean bool3 = this.fx < localc.fx;
        i = 0;
        if (bool3)
          break;
        boolean bool4 = this.fy;
        boolean bool5 = localc.fy;
        i = 0;
        if (bool4 != bool5)
          break;
        boolean bool6 = this.fz < localc.fz;
        i = 0;
        if (bool6)
          break;
        return a(localc);
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
            ...
            bool2 = qu.equals(this.fA, locald.fA);
            i = 0;
          }
          while (!bool2);
          bool3 = qu.equals(this.fB, locald.fB);
          i = 0;
        }
        while (!bool3);
        bool4 = qu.equals(this.fC, locald.fC);
        i = 0;
      }
      while (!bool4);
      return a(locald);
  ...
  public static final class f extends qq<f>
  {
    ...
    public boolean equals(Object paramObject)
    {
                          ...
                          do
                          {
                            ...
                            do
                            {
                              ...
                              do
                              {
                                ...
                                bool2 = qu.equals(this.fE, localf.fE);
                                i = 0;
                              }
                              while (!bool2);
                              bool3 = qu.equals(this.fF, localf.fF);
                              i = 0;
                            }
                            while (!bool3);
                            bool4 = qu.equals(this.fG, localf.fG);
                            i = 0;
                          }
                          while (!bool4);
                          bool5 = qu.equals(this.fH, localf.fH);
                          i = 0;
                        }
                        while (!bool5);
                        bool6 = qu.equals(this.fI, localf.fI);
                        i = 0;
                      }
                      while (!bool6);
                      bool7 = qu.equals(this.fJ, localf.fJ);
                      i = 0;
                    }
                    while (!bool7);
                    bool8 = qu.equals(this.fK, localf.fK);
                    i = 0;
                  }
                  while (!bool8);
                  bool9 = qu.equals(this.fL, localf.fL);
                  i = 0;
                }
                while (!bool9);
                if (this.fM != null)
      ...
      while (locala != null);
      label416: label433: label450: label467: 
      do
      {
        int j = Float.floatToIntBits(this.fQ);
        int k = Float.floatToIntBits(localf.fQ);
        i = 0;
        if (j != k)
          break;
        boolean bool10 = this.fR;
        boolean bool11 = localf.fR;
        i = 0;
        if (bool10 != bool11)
          break;
        boolean bool12 = qu.equals(this.fS, localf.fS);
        i = 0;
        if (!bool12)
          break;
        int m = this.fT;
                    ...
                    do
                    {
                      ...
                      do
                      {
                        ...
                        do
                        {
                          ...
                          bool2 = qu.equals(this.fV, localg.fV);
                          i = 0;
                        }
                        while (!bool2);
                        bool3 = qu.equals(this.fW, localg.fW);
                        i = 0;
                      }
                      while (!bool3);
                      bool4 = qu.equals(this.fX, localg.fX);
                      i = 0;
                    }
                    while (!bool4);
                    bool5 = qu.equals(this.fY, localg.fY);
                    i = 0;
                  }
                  while (!bool5);
                  bool6 = qu.equals(this.fZ, localg.fZ);
                  i = 0;
                }
                while (!bool6);
                bool7 = qu.equals(this.ga, localg.ga);
                i = 0;
              }
              while (!bool7);
              bool8 = qu.equals(this.gb, localg.gb);
              i = 0;
            }
            while (!bool8);
            bool9 = qu.equals(this.gc, localg.gc);
            i = 0;
          }
          while (!bool9);
          bool10 = qu.equals(this.gd, localg.gd);
          i = 0;
        }
        while (!bool10);
        bool11 = qu.equals(this.ge, localg.ge);
        i = 0;
      }
      while (!bool11);
      return a(localg);
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
              ...
              do
              {
                ...
                do
                {
                  ...
                  do
                  {
                    ...
                    bool2 = qu.equals(this.gh, localh.gh);
                    i = 0;
                  }
                  while (!bool2);
                  bool3 = qu.equals(this.gi, localh.gi);
                  i = 0;
                }
                while (!bool3);
                bool4 = qu.equals(this.gj, localh.gj);
                i = 0;
              }
              while (!bool4);
              j = this.gk;
            ...
            while (j != k);
            bool5 = qu.equals(this.gl, localh.gl);
            i = 0;
          }
          while (!bool5);
          m = this.gm;
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
            ...
            bool2 = qu.equals(this.gr, localj.gr);
            i = 0;
          }
          while (!bool2);
          if (this.gs != null)

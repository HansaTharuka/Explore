...
public class nk extends nc
{
    ...
    throws RemoteException
  {
    ...
    label83: for (Object localObject = null; ; localObject = new b(paramb, this))
    {
  ...
  private final class a extends jl<ni>.b<c.a>
  {
    private final int Iv;
    private final String[] aha;

    public a(c.a paramInt, int paramArrayOfString, String[] arg4)
    {
      super(paramInt);
      this.Iv = LocationStatusCodes.eC(paramArrayOfString);
      Object localObject;
      this.aha = localObject;
    }
  ...
  private final class c extends jl<ni>.b<c.b>
  {
    private final int Iv;
    private final String[] aha;
    ...
    public c(int paramb, c.b paramInt1, int paramPendingIntent, PendingIntent arg5)
    {
      super(paramInt1);
      if (paramb == localb);
      while (true)
      {
        je.K(localb);
        this.ahf = paramb;
        this.Iv = LocationStatusCodes.eC(paramPendingIntent);
        Object localObject;
    ...
    public c(int paramb, c.b paramInt1, int paramArrayOfString, String[] arg5)
    {
      super(paramInt1);
      if (paramb == 2);
      for (boolean bool = true; ; bool = false)

...
public final class ql
{
  ...
  private static qm.a.a a(List<Asset> paramList, Object paramObject)
  {
    ...
    while (true)
    {
      ...
      {
        locala1.type = 1;
        locala1.ayu.ayv = ((byte[])(byte[])paramObject);
        continue;
      }
      if ((paramObject instanceof String[]))
      {
        locala1.type = 11;
        locala1.ayu.ayF = ((String[])(String[])paramObject);
        continue;
      }
      if ((paramObject instanceof long[]))
      {
        locala1.type = 12;
        locala1.ayu.ayG = ((long[])(long[])paramObject);
        continue;
      }
      if ((paramObject instanceof float[]))
      {
        locala1.type = 15;
        locala1.ayu.ayH = ((float[])(float[])paramObject);
        continue;
      }

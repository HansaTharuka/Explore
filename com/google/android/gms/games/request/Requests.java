...
public abstract interface Requests
{
  ...
  public static abstract interface LoadRequestSummariesResult extends Releasable, Result
  {
  }

  public static abstract interface LoadRequestsResult extends Releasable, Result
  {
    public abstract GameRequestBuffer getRequests(int paramInt);
  }

  public static abstract interface SendRequestResult extends Result
  {
  }

  public static abstract interface UpdateRequestsResult extends Releasable, Result
  {

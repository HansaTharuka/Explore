...
public abstract interface TurnBasedMultiplayer
{
  ...
  public abstract PendingResult<UpdateMatchResult> finishMatch(GoogleApiClient paramGoogleApiClient, String paramString, byte[] paramArrayOfByte, ParticipantResult[] paramArrayOfParticipantResult);
  ...
  public abstract PendingResult<UpdateMatchResult> takeTurn(GoogleApiClient paramGoogleApiClient, String paramString1, byte[] paramArrayOfByte, String paramString2, ParticipantResult[] paramArrayOfParticipantResult);

  public abstract void unregisterMatchUpdateListener(GoogleApiClient paramGoogleApiClient);

  public static abstract interface CancelMatchResult extends Result
  {
    public abstract String getMatchId();
  }

  public static abstract interface InitiateMatchResult extends Result
  {
    public abstract TurnBasedMatch getMatch();
  }

  public static abstract interface LeaveMatchResult extends Result
  {
    public abstract TurnBasedMatch getMatch();
  }

  public static abstract interface LoadMatchResult extends Result
  {
    public abstract TurnBasedMatch getMatch();
  }

  public static abstract interface LoadMatchesResult extends Releasable, Result
  {
    public abstract LoadMatchesResponse getMatches();
  }

  public static abstract interface UpdateMatchResult extends Result
  {
    public abstract TurnBasedMatch getMatch();
  }
}

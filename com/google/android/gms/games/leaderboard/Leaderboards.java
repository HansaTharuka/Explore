...
public abstract interface Leaderboards
{
  ...
  public static abstract interface LeaderboardMetadataResult extends Releasable, Result
  {
    public abstract LeaderboardBuffer getLeaderboards();
  }

  public static abstract interface LoadPlayerScoreResult extends Result
  {
    public abstract LeaderboardScore getScore();
  }

  public static abstract interface LoadScoresResult extends Releasable, Result
  {
  ...
  public static abstract interface SubmitScoreResult extends Releasable, Result
  {

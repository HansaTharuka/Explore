...
public abstract interface Achievements
{
  ...
  public static abstract interface LoadAchievementsResult extends Releasable, Result
  {
    public abstract AchievementBuffer getAchievements();
  }

  public static abstract interface UpdateAchievementResult extends Result
  {

...
public abstract interface Quests
{
  ...
  public abstract PendingResult<LoadQuestsResult> loadByIds(GoogleApiClient paramGoogleApiClient, boolean paramBoolean, String[] paramArrayOfString);
  ...
  public static abstract interface AcceptQuestResult extends Result
  {
    public abstract Quest getQuest();
  }

  public static abstract interface ClaimMilestoneResult extends Result
  {
  ...
  public static abstract interface LoadQuestsResult extends Releasable, Result
  {

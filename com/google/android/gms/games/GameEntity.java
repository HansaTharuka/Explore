  ...
  implements Game
{
  ...
  static boolean a(Game paramGame, Object paramObject)
  {
    ...
    while (true)
    {
      ...
      label475: for (boolean bool2 = bool1; (!jv.equal(localBoolean, Boolean.valueOf(bool2))) || (!jv.equal(Boolean.valueOf(localGame.areSnapshotsEnabled()), Boolean.valueOf(paramGame.areSnapshotsEnabled()))) || (!jv.equal(localGame.getThemeColor(), paramGame.getThemeColor())); bool2 = false)
        return false;
    }
  }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    while (true)
    {
      ...
      break;
      label189: str2 = this.WE.toString();
      break label90;
      label201: str3 = this.WF.toString();
      break label110;
      label213: j = 0;
      break label126;
      label219: i = 0;
  ...
  static final class GameEntityCreatorCompat extends GameEntityCreator
  {
    public GameEntity cl(Parcel paramParcel)
    {
      ...
      label186: label196: label206: label212: for (boolean bool2 = true; ; bool2 = false)
      {

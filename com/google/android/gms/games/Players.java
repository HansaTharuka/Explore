...
public abstract interface Players
{
  ...
  public static abstract interface LoadOwnerCoverPhotoUrisResult extends Result
  {
  }

  public static abstract interface LoadPlayersResult extends Releasable, Result
  {
    public abstract PlayerBuffer getPlayers();
  }

  public static abstract interface LoadProfileSettingsResult extends Result
  {
  ...
  public static abstract interface LoadXpForGameCategoriesResult extends Result
  {
  }

  public static abstract interface LoadXpForGamesResult extends Result
  {
  }

  public static abstract interface LoadXpStreamResult extends Result
  {
  }
}

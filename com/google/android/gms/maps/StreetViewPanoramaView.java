...
public class StreetViewPanoramaView extends FrameLayout
{
    ...
    implements StreetViewLifecycleDelegate
  {
    ...
    public void getStreetViewPanoramaAsync(OnStreetViewPanoramaReadyCallback paramOnStreetViewPanoramaReadyCallback)
    {
      try
      {
        this.alz.getStreetViewPanoramaAsync(new u.a(paramOnStreetViewPanoramaReadyCallback)
        {
          public void a(IStreetViewPanoramaDelegate paramIStreetViewPanoramaDelegate)
            throws RemoteException
          {
            this.alo.onStreetViewPanoramaReady(new StreetViewPanorama(paramIStreetViewPanoramaDelegate));
          }
        });
        return;
      }
  ...
  static class b extends a<StreetViewPanoramaView.a>
  {

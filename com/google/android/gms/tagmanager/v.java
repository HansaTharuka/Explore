  ...
  implements DataLayer.c
{
  ...
  {
    this.arb.execute(new Runnable(parama)
    {
      public void run()
      {
        this.arh.h(v.a(v.this));
      }
    });
  }
  ...
  {
    List localList = j(paramList);
    this.arb.execute(new Runnable(localList, paramLong)
    {
      public void run()
      {
        v.a(v.this, this.are, this.arf);
      }
    });
  }
  ...
  {
    this.arb.execute(new Runnable(paramString)
    {
      public void run()
      {
        v.a(v.this, this.ari);

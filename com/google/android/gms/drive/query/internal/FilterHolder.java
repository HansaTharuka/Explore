  ...
  implements SafeParcelable
{
  ...
  public FilterHolder(Filter paramFilter)
  {
    ...
    label75: InFilter localInFilter;
    label94: MatchAllFilter localMatchAllFilter;
    if ((paramFilter instanceof ComparisonFilter))
    {
      ...
      label113: this.Sq = localMatchAllFilter;
      if (!(paramFilter instanceof HasFilter))
        break label231;
    }
    label202: label207: label213: label219: label225: label231: for (HasFilter localHasFilter = (HasFilter)paramFilter; ; localHasFilter = null)
    {

...
public class r extends jl<ae>
{
  ...
  PendingResult<Status> a(GoogleApiClient paramGoogleApiClient, DriveId paramDriveId, int paramInt)
  {
    ...
    return paramGoogleApiClient.b(new q.a(paramGoogleApiClient, paramDriveId, paramInt)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        paramr.iG().a(new AddEventListenerRequest(this.PQ, this.PR), null, null, new bg(this));
      }
    });
  }
  ...
  PendingResult<Status> a(GoogleApiClient paramGoogleApiClient, DriveId paramDriveId, int paramInt, c paramc)
  {
    ...
    while (true)
    {
      ...
      synchronized (this.PP)
      {
        ...
        BaseImplementation.a locala = paramGoogleApiClient.b(new q.a(paramGoogleApiClient, paramDriveId, paramInt, localaa2)
        {
          protected void a(r paramr)
            throws RemoteException
          {
            paramr.iG().a(new AddEventListenerRequest(this.PQ, this.PR), this.PS, null, new bg(this));
          }
        });
        return locala;
  ...
  PendingResult<Status> b(GoogleApiClient paramGoogleApiClient, DriveId paramDriveId, int paramInt)
  {
    ...
    return paramGoogleApiClient.b(new q.a(paramGoogleApiClient, paramDriveId, paramInt)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        paramr.iG().a(new RemoveEventListenerRequest(this.PQ, this.PR), null, null, new bg(this));
      }
    });
  }
  ...
  PendingResult<Status> b(GoogleApiClient paramGoogleApiClient, DriveId paramDriveId, int paramInt, c paramc)
  {
    ...
    BaseImplementation.a locala = paramGoogleApiClient.b(new q.a(paramGoogleApiClient, paramDriveId, paramInt, localaa)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        paramr.iG().a(new RemoveEventListenerRequest(this.PQ, this.PR), this.PU, null, new bg(this));
      }
    });
    monitorexit;
    return locala;
  ...
  PendingResult<Status> cancelPendingActions(GoogleApiClient paramGoogleApiClient, List<String> paramList)
  {
    ...
    while (true)
    {
      jx.L(bool1);
      jx.a(isConnected(), "Client must be connected");
      return paramGoogleApiClient.b(new q.a(paramGoogleApiClient, paramList)
      {
        protected void a(r paramr)
          throws RemoteException
        {
          paramr.iG().a(new CancelPendingActionsRequest(this.PV), new bg(this));
        }
      });
      bool2 = false;
      break;

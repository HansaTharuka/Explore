  ...
  implements DriveApi
{
  ...
  {
    return paramGoogleApiClient.a(new b(paramGoogleApiClient, paramInt)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        paramr.iG().a(new CreateContentsRequest(this.PG), new p.h(this));
      }
    });
  }
  ...
  {
    return paramGoogleApiClient.a(new e(paramGoogleApiClient, paramString)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        paramr.iG().a(new GetMetadataRequest(DriveId.bi(this.PH)), new p.c(this));
      }
    });
  }
  ...
  public PendingResult<DriveApi.MetadataBufferResult> query(GoogleApiClient paramGoogleApiClient, Query paramQuery)
  {
    ...
    return paramGoogleApiClient.a(new g(paramGoogleApiClient, paramQuery)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        paramr.iG().a(new QueryRequest(this.PE), new p.i(this));
      }
    });
  }
  ...
  {
    return paramGoogleApiClient.b(new q.a(paramGoogleApiClient)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        paramr.iG().a(new bg(this));
      }
    });
  }

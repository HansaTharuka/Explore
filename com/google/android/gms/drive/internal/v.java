  ...
  implements DriveFolder
{
  ...
  private PendingResult<DriveFolder.DriveFileResult> a(GoogleApiClient paramGoogleApiClient, MetadataChangeSet paramMetadataChangeSet, int paramInt1, int paramInt2, ExecutionOptions paramExecutionOptions)
  {
    ExecutionOptions.a(paramGoogleApiClient, paramExecutionOptions);
    return paramGoogleApiClient.b(new d(paramGoogleApiClient, paramMetadataChangeSet, paramInt1, paramInt2, paramExecutionOptions)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        this.Qi.iz().setContext(paramr.getContext());
        CreateFileRequest localCreateFileRequest = new CreateFileRequest(v.this.getDriveId(), this.Qi.iz(), this.Qj, this.Qk, this.Ql);
        paramr.iG().a(localCreateFileRequest, new v.a(this));
      }
    });
  }
  ...
  public PendingResult<DriveFolder.DriveFolderResult> createFolder(GoogleApiClient paramGoogleApiClient, MetadataChangeSet paramMetadataChangeSet)
  {
    ...
    return paramGoogleApiClient.b(new f(paramGoogleApiClient, paramMetadataChangeSet)
    {
      protected void a(r paramr)
        throws RemoteException
      {
        this.Qi.iz().setContext(paramr.getContext());
        paramr.iG().a(new CreateFolderRequest(v.this.getDriveId(), this.Qi.iz()), new v.b(this));
      }
    });
  }
